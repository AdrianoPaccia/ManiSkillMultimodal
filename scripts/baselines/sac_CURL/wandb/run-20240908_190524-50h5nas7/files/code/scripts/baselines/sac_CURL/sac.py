    ...
    while global_step < args.total_timesteps:
        ...
        for local_update in range(args.grad_steps_per_iteration):
            ...
            if global_update % args.policy_frequency == 0:  # TD 3 Delayed update support
                ...
                #distances
                distances_pos = [
                    [cs(z1, z_mom2) for z_mom2 in augment_z_mom2] for z1 in augment_z1
                ]
                distances_neg = [
                    [cs(z1, z_mom2[torch.randperm(args.batch_size)]) for z_mom2 in (augment_z_mom2)] for z1 in augment_z1
                ]
                ...
                for i in range(n):
                    for j in range(n):
                        ...
                        if i==j:
                            intra_losses.append(torch.mean(loss_ij))
                        else:
